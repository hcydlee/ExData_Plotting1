...
plot(hp$datetime,hp$Global_active_power,type='l',xlab='',
     ylab='Global Active Power')

plot(hp$datetime,hp$Voltage,type='l',xlab='datetime',
     ylab='Voltage')



plot(hp$datetime,hp$Sub_metering_1,type='l',xlab='',
...
plot(hp$datetime,hp$Global_reactive_power,type='l',xlab='datetime',
